...
public class UserActionLog extends org.apache.avro.specific.SpecificRecordBase
		implements org.apache.avro.specific.SpecificRecord {
	private static final long serialVersionUID = 4242450194142077808L;
	public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse(
			"{\"type\":\"record\",\"name\":\"UserActionLog\",\"namespace\":\"com.zhiyou100.schema\",\"fields\":[{\"name\":\"userName\",\"type\":\"string\"},{\"name\":\"actionType\",\"type\":\"string\"},{\"name\":\"ipAddress\",\"type\":\"string\"},{\"name\":\"gender\",\"type\":\"int\"},{\"name\":\"provience\",\"type\":\"string\"}]}");
	...
	private static final BinaryMessageEncoder<UserActionLog> ENCODER = new BinaryMessageEncoder<UserActionLog>(MODEL$,
			SCHEMA$);

	private static final BinaryMessageDecoder<UserActionLog> DECODER = new BinaryMessageDecoder<UserActionLog>(MODEL$,
			SCHEMA$);
	...
	public static UserActionLog fromByteBuffer(java.nio.ByteBuffer b) throws java.io.IOException {
	...
	@Deprecated
	public java.lang.CharSequence actionType;
	@Deprecated
	public java.lang.CharSequence ipAddress;
	@Deprecated
	public int gender;
	@Deprecated
	public java.lang.CharSequence provience;
	 ...
	 * @param actionType
	 *            The new value for actionType
	 * @param ipAddress
	 *            The new value for ipAddress
	 * @param gender
	 *            The new value for gender
	 * @param provience
	 *            The new value for provience
	 */
	public UserActionLog(java.lang.CharSequence userName, java.lang.CharSequence actionType,
			java.lang.CharSequence ipAddress, java.lang.Integer gender, java.lang.CharSequence provience) {
	...
	public void put(int field$, java.lang.Object value$) {
		...
		case 0:
			...
			break;
		case 1:
			actionType = (java.lang.CharSequence) value$;
			break;
		case 2:
			ipAddress = (java.lang.CharSequence) value$;
			break;
		case 3:
			gender = (java.lang.Integer) value$;
			break;
		case 4:
			provience = (java.lang.CharSequence) value$;
			break;
		default:
			throw new org.apache.avro.AvroRuntimeException("Bad index");
		}
	 ...
	 */
	public static com.zhiyou100.schema.UserActionLog.Builder newBuilder(
			com.zhiyou100.schema.UserActionLog.Builder other) {
		return new com.zhiyou100.schema.UserActionLog.Builder(other);
	}

	/**
	 * Creates a new UserActionLog RecordBuilder by copying an existing
	...
	public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserActionLog>
		...
		public UserActionLog build() {
			try {
				...
				record.userName = fieldSetFlags()[0] ? this.userName
						: (java.lang.CharSequence) defaultValue(fields()[0]);
				record.actionType = fieldSetFlags()[1] ? this.actionType
						: (java.lang.CharSequence) defaultValue(fields()[1]);
				record.ipAddress = fieldSetFlags()[2] ? this.ipAddress
				...
				record.provience = fieldSetFlags()[4] ? this.provience
	...
	@SuppressWarnings("unchecked")
	private static final org.apache.avro.io.DatumWriter<UserActionLog> WRITER$ = (org.apache.avro.io.DatumWriter<UserActionLog>) MODEL$
	...
	@SuppressWarnings("unchecked")
	private static final org.apache.avro.io.DatumReader<UserActionLog> READER$ = (org.apache.avro.io.DatumReader<UserActionLog>) MODEL$
